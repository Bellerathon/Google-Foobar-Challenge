...
#there is a path from that state to a terminal state. That is, the processing will always eventually end in a stable state. The ore starts in state 0. 
...
if __name__ == "__main__":
    ...
    print(len(solution(m)) == 4)
    print(len(solution(m2)) == 3)